...
'''sh
./dool1 --postgresql-time -a -s -i -r --aio --fs --ipc --lock --raw --socket --tcp --udp --unix --vm --vm-adv --zones --postgresql-dbsize --postgresql-conn --postgresql-lockwaits --postgresql-transactions --postgresql-buffer --postgresql-settings --output ./metrics1.csv --noupdate 5
