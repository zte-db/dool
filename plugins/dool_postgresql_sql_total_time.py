...
class dstat_plugin(dstat):
    ...
    def __init__(self):
        self.name = 'postgresql sql_total_time'
    ...
    def extract(self,outputfile):
        try:
            ...
            c.execute(sql)
            # io_time,rolname,dbname,calls,total_time,mean_time,blk_read_time,blk_write_time,queryid,query = c.fetchall()
            output = c.fetchall()

            line1 = '-----------------------------------------------------------------------------postgresql-sql_total_time----------------------------------------------------------------------------'
